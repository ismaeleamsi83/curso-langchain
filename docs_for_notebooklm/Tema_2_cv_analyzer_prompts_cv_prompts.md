# Documentación: Tema 2/cv_analyzer/prompts/cv_prompts.py

Este documento describe el propósito y funcionamiento del archivo `cv_prompts.py`.

## Descripción General
Este archivo centraliza la lógica de los mensajes (prompts) utilizados para interactuar con el LLM en el proyecto de análisis de CV. Define el rol del sistema y las instrucciones para el análisis del currículum.

## Funcionalidades Clave
- **SystemMessagePromptTemplate**: Define la personalidad de un "experto reclutador senior" con criterios de evaluación específicos.
- **HumanMessagePromptTemplate**: Contiene las instrucciones detalladas para el análisis, incluyendo el peso de cada criterio (experiencia, habilidades, formación, estabilidad).
- **ChatPromptTemplate**: Combina ambos mensajes en una estructura coherente lista para ser procesada por el modelo.
